...
SECRET_KEY = 'django-insecure-(kr9%_2rxz)l!9arzuda!*m(xy*up!3crw0k3h-^*#%jm1v2x4'
...
# Define the location of your static files directory
STATICFILES_DIRS = [
    BASE_DIR / 'static',  # Assumes a 'static' directory in the root of your project
]
